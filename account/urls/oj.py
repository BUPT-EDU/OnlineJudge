...
from ..views.oj import (ApplyResetPasswordAPI, ResetPasswordAPI, UserRegisterMidAPI,
...
urlpatterns = [
    ...
    url(r"^register_mid/?$", UserRegisterMidAPI.as_view(), name="user_register_mid_api"),
