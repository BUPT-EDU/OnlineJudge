...
from ..views.admin import ContestAnnouncementAPI, ContestAPI, ACMContestHelper, DownloadContestSubmissions, ContestGroupAPI
...
urlpatterns = [
    ...
    url(r"^contest_group/?$", ContestGroupAPI.as_view(), name="contest_group_api")
]
